...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--data_dir', type=str,
                                 default='PATH_TO_YOUR_H3_6M_ROOT',
                                 help='path to your h3.6m dataset')
        self.parser.add_argument('--exp', type=str, default='temp', help='ID of experiment')
        ...
        self.parser.add_argument('--skip_rate_test', type=int, default=5, help='skip rate of samples for temp')
        ...
        self.parser.add_argument('--dct_n', type=int, default=20, help='DCT Size (Normally 20)')
